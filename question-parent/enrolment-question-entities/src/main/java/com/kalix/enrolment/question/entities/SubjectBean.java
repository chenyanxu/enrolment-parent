...
public class SubjectBean extends BaseLogicDeleteEntity {
    ...
    @ExcelField(title = "主观题类型", align = 1, dictType = "主观题类型", sort = 10)
    ...
    @ExcelField(title = "答题要求", align = 1, sort = 40)
    ...
    @ExcelField(title = "试题解析", align = 1, sort = 50)
    ...
    @ExcelField(title = "评分标准", align = 1, sort = 60)
